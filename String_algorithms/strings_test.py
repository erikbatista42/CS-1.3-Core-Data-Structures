...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('adf', 'f') is True
        assert contains('adf', 'df') is True
        assert contains('adf', 'adf') is True 
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('adf', 'x') is False
        assert contains('adf', 'dz') is False
        assert contains('adf', 'adfz') is False
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('adfadfadft', 'adft') is True
        assert contains('adfadfadft', 'ft') is True
        assert contains('adfadfadft', 't') is True
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('bb', 'b') == 0
        assert find_index('bbabbb', 'bbb') == 3
        assert find_index('abccabcap', 'ap') == 7
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('asd', 'sdf') is None
        assert find_index('pdf', 'pda') is None
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        assert find_index('abcabcdef', 'abcdef') == 3  # overlapping prefixd
        ...
        assert find_index('yodel', 'el') == 3
        assert find_index('yodel lihoo', 'ho') == 8
        assert find_index('yodel ling', 'ling') == 6
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('bbb', 'bb') == [0, 1]
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('zebra', 'zebrax') == []
        assert find_all_indexes('booming', 'boomx') == []
        assert find_all_indexes('applebrew', 'brewho') == []
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        assert find_all_indexes('boom coot', 'oo') == [1, 6]
        assert find_all_indexes('bboom bboot', 'bb') == [0, 6]
        assert find_all_indexes('patxizxis', 'xis') == [6]
